...
<fieldset>
    <legend class="Head" id="lgDefinitions" runat="server">Attribute Definition</legend>
        <div id="div_Name">
            <asp:Label ID="lblName" runat="server" resourceKey="lblName" CssClass="Normal" />
            <asp:TextBox ID="txtName" runat="server" CssClass="NormalTextBox" /><asp:RequiredFieldValidator ID="rfvName" CssClass="Normal" runat="server" ControlToValidate="txtName" ErrorMessage="Name is required" />
        </div>
        <div id="div_DefaultValue">
            <asp:Label ID="lblDefaultValue" runat="server" resourceKey="lblDefaultValue" CssClass="Normal" />
            <asp:TextBox ID="txtDefaultValue" runat="server" CssClass="NormalTextBox" />
        </div>
</fieldset>
<br />
<div id="div_commands">
